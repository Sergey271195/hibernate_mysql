...
@Repository
public interface AggSearchEngineGoalReaches extends JpaRepository<com.illuminator.db.entity.goal.AdvEngineGoalReaches, Long> {
    ...
    @Query(value = "SELECT r.count as count, s.name as sourceName, a.name as goalName FROM " +
            ...
            "LEFT JOIN search_engine s ON r.sourceid = s.id ORDER BY goalName, count DESC", nativeQuery = true)

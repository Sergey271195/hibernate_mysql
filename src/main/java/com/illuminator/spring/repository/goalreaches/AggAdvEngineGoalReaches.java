...
@Repository
public interface AggAdvEngineGoalReaches extends JpaRepository<com.illuminator.entity.goal.AdvEngineGoalReaches, Long> {
    ...
    @Query(value = "WITH r AS (SELECT sum(reaches) as count, goalid, sourceid " +
            ...
            "LEFT JOIN adv_engine s ON r.sourceid = s.id ORDER BY goalName, r.count DESC", nativeQuery = true)

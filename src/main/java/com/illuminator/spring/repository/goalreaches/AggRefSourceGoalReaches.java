...
@Repository
public interface AggRefSourceGoalReaches extends JpaRepository<com.illuminator.entity.goal.AdvEngineGoalReaches, Long> {
    ...
    @Query(value = "WITH r AS (SELECT sum(reaches) as count, goalid, sourceid " +
            ...
            "LEFT JOIN ref_source s ON r.sourceid = s.id ORDER BY goalName, r.count DESC", nativeQuery = true)
